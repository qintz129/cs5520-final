...
import { StyleSheet, Text, View, Alert, Keyboard, KeyboardAvoidingView, Platform, SafeAreaView, ScrollView} from "react-native";
import {
  writeToDB, 
  updateToDB,
    ...
    <SafeAreaView style={styles.container}> 
      ...
      <ScrollView>
        <View style={styles.inner}>   
          <ImageManager receiveImageUri={receiveImageUri} receiveNewImage={receiveNewImage} initialImageUri={downloadUri} mode="book"/>
          <CustomInput
            title="Book Name*"
            value={bookName}
